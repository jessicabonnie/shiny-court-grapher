...
pander(emagsECOMonthly, caption = "Monthly Frequency of ECOs Issued for Adults, FY2008-FY2015", split.cells=10)
```
...
p + ylim(0,max(ECOmonthly2$count)) + geom_line(size=1.2) + ggtitle("Monthly Frequency of ECOs Issued for Adults, FY2008-FY2015") + geom_point(aes(shape=factor(FYear)), size=3) + scale_colour_discrete(name  ="Fiscal Year") + scale_shape_discrete(name="Fiscal Year")
```
...
pander(emags2, caption = "Monthly Frequency of TDOs Issued for Adults, FY2008-FY2015", split.cells=10)
...
pander(CMS_MonthlyHearingsInitial, caption  = "Monthly Frequency of Initial Commitment Hearings for Adults, FY09-FY15", split.cells=9)
```
...
pander(CMS_MonthlyHearingsRecommit, caption  = "Monthly Frequency of Recommitment Hearings for Adults, FY09-FY15", split.cells=9)
```
